...
def main():
    ...
    with wandb.init(project=args.experiment_name, name=args.agent_name, config=args, mode=mode):
        ...
        train_envs_factory, action_space, obs_space = VecEnv.create_factory(
            ...
            env_kwargs={"task": generate_task(task_generator_id='general'),
        ...
        actor_factory = OffPolicyActor.create_factory(
            obs_space, action_space, algo_name, recurrent_net=False,
...
def get_args():
    ...
    # Wandb
    parser.add_argument(
        '--experiment-name', default=None, help='Name of the wandb experiment the agent belongs to')
    parser.add_argument(
